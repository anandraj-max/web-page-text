// Kling AI image generation — task status check
// GET /.netlify/functions/kling-image-status?task_id=<id>
// Returns: { task_status, images?, message? }
...
exports.handler = async (event) => {
  ...
  try {
    ...
    return json(200, {
      ...
      images: taskData.task_result?.images || [],
      raw: taskData,
    });
  } catch (e) {
